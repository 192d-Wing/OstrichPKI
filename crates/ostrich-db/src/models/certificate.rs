...
pub struct Certificate {
    ...
    /// Identifier of the request that produced this certificate.
    ///
    /// NIAP PP-CA: FDP_CER_EXT.2 - Certificate request linkage. The same value
    /// is recorded on the issuance audit event, giving end-to-end traceability
    /// (request -> certificate -> audit). May be a caller-supplied request id
    /// (ACME order, EST enrollment) or one generated by the CA at issuance.
