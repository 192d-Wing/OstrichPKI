...
//! It serves the React (AWS Cloudscape) console — built separately under `web/`
//! with Vite — and provides OAuth/OIDC authentication with Keycloak, along with
//! an API proxy to backend services.
//!
//! COMPLIANCE MAPPING:
