...
impl TokenType {
    ...
    fn icon(&self) -> &'static str {
        match self {
            TokenType::Smartcard => "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z",
            TokenType::Yubikey => "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z",
            TokenType::SoftToken => "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
            TokenType::Hsm => "M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01",
        }
    }
}
        ...
        Column {
            ...
            render: {
                ...
                Rc::new(move |token: &Token| {
                    ...
                    let on_view = on_view.clone();
                    let on_revoke = on_revoke.clone();
                    let can_revoke = matches!(token.status, TokenStatus::Active | TokenStatus::Locked);
